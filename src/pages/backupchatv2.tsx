  ...
  const handleChatSelect = async (
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log("First message structure:", data.payload?.[0]); // Debug para ver a estrutura        console.log("Message type example:", data.payload?.[0]?.message_type, typeof data.payload?.[0]?.message_type);
